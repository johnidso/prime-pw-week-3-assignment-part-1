...
let favoriteFoods = [ 'curry', 'lasagna', 'enchiladas', 'khao soi' ];
...
console.log('Removed the final food:', removedFood)
console.log(favoriteFoods);
...
favoriteFoods.unshift('cobb salad');
console.log(favoriteFoods);
